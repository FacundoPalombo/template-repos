...
El primer paso es registrarte en [github](https://github.com/) y solicitar asociarte a la organización TodoPago. Podrás encontrar más info de como contribuir en [éste link](/CONTRIBUTING.md). También podrás ver nuestra lista de [contribuyentes](https://github.com/TodoPago/$este-repo/graphs/contributors)
